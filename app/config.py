# ai-security-agent/app/config.py
import os
...
class Settings(BaseSettings):
    ...
    # --- LLM Configuration ---
    LLM_MODEL_NAME: str = "mistral"  # For lighter mode, change to "phi3:mini"
    OLLAMA_URL: str = "http://localhost:11434"
    LLM_MAX_FAILURES: int = 3
    LLM_COOLDOWN_SECONDS: int = 45
    LLM_HEALTH_CHECK_INTERVAL: int = 30  # Frequency of reconnection attempts
